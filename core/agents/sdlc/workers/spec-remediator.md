...
- Mantener el lifecycle SDD y asegurar alineación entre artefactos. ## Restricciones Obligatorias
...
- **Active Repo Guard**: Si desconoces la ruta del repositorio activo, detente con `Blocked: active repository path required`. ## Guías
